                ...
                return (
                  ...
                  >
                    <div className={`w-full h-full rounded-3xl overflow-hidden border transition-all duration-500 ${
                      absOffset === 0 ? `bg-white ${theme.border} shadow-2xl ring-1 ring-[#0D9488]/20` : `bg-[#E0F2F1] ${theme.border}`
                    }`}>
                      <div className="h-2/3 relative overflow-hidden bg-[#CCFBF1]">
                        {/* Visual placeholder */}
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className={`w-20 h-20 rounded-full border flex items-center justify-center transition-transform duration-700 border-[#0D9488]/20 ${absOffset === 0 ? 'scale-110' : 'scale-90'}`}>
                            <Play className={`w-6 h-6 text-[#0D9488] ${absOffset === 0 ? 'opacity-100' : 'opacity-20'}`} />
                          </div>
                        </div>
                      </div>
