              ...
              >
                ...
                <div className="space-y-3">
                  {project.architecture?.nodes.filter(n => n.type === type).map(node => (
                    <div key={node.id} className={`p-4 rounded-xl border bg-[#E0F2F1] ${theme.border} ${theme.text} text-sm font-medium flex items-center gap-3 hover:bg-[#CCFBF1] transition-colors duration-300`}>
