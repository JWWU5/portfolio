...
export const PROJECTS: Project[] = [
  {
    ...
    challenges: [
      ...
      { 
        ...
        solution: "Implemented a complex mathematical model to translate raw sensor data into accurate 3D rotations for the virtual spine. This required filtering noise from the sensors and applying quaternion math to ensure smooth and realistic movement." 
      },
      {
